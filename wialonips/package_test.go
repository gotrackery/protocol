...
func TestDecode(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Invalid Package - 2 bytes only",
			args: args{
				data: "2358",
				v:    UnknownVersion,
			},
		...
		{
			name: "Invalid Package - unknown package type",
			args: args{
		...
		{
			name: "Invalid Package - bad structure",
			args: args{
		...
		{
			name: "ShortData Package v1.1 all zero",
			args: args{
			...
			want: Package{
				...
				Message: &ShortenedDataMessage{
					...
					Point: generic.PointWGS84{
						Lon:   generic.AxisWGS84{Cardinal: generic.West},
						Lat:   generic.AxisWGS84{Cardinal: generic.South},
						Valid: true,
					},
		...
		{
			name: "ShortData Package v2.0 all na",
			args: args{
			...
			want: Package{
				...
				Message: &ShortenedDataMessage{
					...
					Point: generic.PointWGS84{
						Lon:   generic.AxisWGS84{Cardinal: generic.East},
						Lat:   generic.AxisWGS84{Cardinal: generic.North},
						Valid: false,
					},
			...
			want: Package{
				...
				Message: &DataMessage{
					ShortenedDataMessage: ShortenedDataMessage{
						...
						Point: generic.PointWGS84{
							Lon:   generic.AxisWGS84{Coordinate: 04003.28140, Cardinal: generic.East},
							Lat:   generic.AxisWGS84{Coordinate: 5425.98960, Cardinal: generic.North},
							Valid: true,
						},
			...
			want: Package{
				...
				Message: &DataMessage{
					ShortenedDataMessage: ShortenedDataMessage{
						...
						Point: generic.PointWGS84{
							Lon:   generic.AxisWGS84{Coordinate: 09512.0158, Cardinal: generic.East},
							Lat:   generic.AxisWGS84{Coordinate: 5557.5757, Cardinal: generic.North},
							Valid: true,
						},
						Speed:    null.NewFloat(0.0, true),
			...
			want: Package{
				...
				Message: &DataMessage{
					ShortenedDataMessage: ShortenedDataMessage{
						...
						Point: generic.PointWGS84{
							Lon:   generic.AxisWGS84{Coordinate: 03740.7143, Cardinal: generic.East},
							Lat:   generic.AxisWGS84{Coordinate: 5550.8514, Cardinal: generic.North},
							Valid: true,
						},
						Speed:    null.NewFloat(0.0, true),
						Course:   null.NewInt(0, true),
			...
			want: Package{
				...
				Message: &DataMessage{
					ShortenedDataMessage: ShortenedDataMessage{
						RegisteredAt: time.Date(2023, time.January, 24, 14, 14, 43, 0, time.UTC),
						Point: generic.PointWGS84{
							Lon:   generic.AxisWGS84{Coordinate: 03745.0665, Cardinal: generic.East},
							Lat:   generic.AxisWGS84{Coordinate: 5533.8612, Cardinal: generic.North},
							Valid: true,
						},
						Speed:    null.NewFloat(0.0, true),
			...
			want: Package{
				...
				Message: &DataMessage{
					ShortenedDataMessage: ShortenedDataMessage{
						...
						Point: generic.PointWGS84{
							Lon:   generic.AxisWGS84{Coordinate: 07655.5671, Cardinal: generic.East},
							Lat:   generic.AxisWGS84{Coordinate: 5515.9595, Cardinal: generic.North},
							Valid: true,
						},
						Speed:    null.NewFloat(0.0, true),
			...
			want: Package{
				...
				Message: &DataMessage{
					ShortenedDataMessage: ShortenedDataMessage{
						...
						Point: generic.PointWGS84{
							Lon:   generic.AxisWGS84{Coordinate: 04312.9038, Cardinal: generic.East},
							Lat:   generic.AxisWGS84{Coordinate: 5748.3329, Cardinal: generic.North},
							Valid: true,
						},
			...
			want: Package{
				...
				Message: &DataMessage{
					ShortenedDataMessage: ShortenedDataMessage{
						...
						Point: generic.PointWGS84{
							Lon:   generic.AxisWGS84{Coordinate: 04152.2760, Cardinal: generic.East},
							Lat:   generic.AxisWGS84{Coordinate: 5750.1249, Cardinal: generic.North},
							Valid: true,
						},
				...
				Message: &BlackBoxMessage{
					...
					DataMessages: []DataMessage{
						{ShortenedDataMessage: ShortenedDataMessage{
							...
							Point: generic.PointWGS84{
								Lon:   generic.AxisWGS84{Coordinate: 03734.7740, Cardinal: generic.East},
								Lat:   generic.AxisWGS84{Coordinate: 5547.7850, Cardinal: generic.North},
								Valid: true,
							},
							Speed:    null.NewFloat(0.0, true),
						...
						{ShortenedDataMessage: ShortenedDataMessage{
							...
							Point: generic.PointWGS84{
								Lon:   generic.AxisWGS84{Coordinate: 0.0, Cardinal: generic.East},
								Lat:   generic.AxisWGS84{Coordinate: 0.0, Cardinal: generic.North},
								Valid: true,
							},
							Speed:    null.NewFloat(0.0, true),
							Course:   null.NewInt(0, true),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := NewPackage(tt.args.v, tt.args.imei)
			err = got.Decode(data)
